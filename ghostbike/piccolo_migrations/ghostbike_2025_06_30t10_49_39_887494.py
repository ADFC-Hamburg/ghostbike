...
class AccidentCode(Table, tablename="accident_code", schema=None):
    code = Integer(
        default=0,
        null=False,
        primary_key=True,
...
class Ghostbike(Table, tablename="ghostbike", schema=None):
    id = Serial(
        null=False,
        primary_key=True,
        unique=False,
...
async def forwards():
    ...
    manager.add_column(
        table_class_name="GuardianGhostbike",
        tablename="guardian_ghostbike",
    ...
    manager.add_column(
        table_class_name="Ghostbike",
        tablename="ghostbike",
        column_name="radunfall_index",
        db_column_name="radunfall_index",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 8,
    ...
    manager.add_column(
        table_class_name="Ghostbike",
        tablename="ghostbike",
        column_name="location_population",
        db_column_name="location_population",
    ...
    manager.add_column(
        table_class_name="Ghostbike",
        tablename="ghostbike",
        column_name="accident_description",
        db_column_name="accident_description",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 500,
    ...
    manager.add_column(
        table_class_name="Ghostbike",
        tablename="ghostbike",
        column_name="accident_code",
        db_column_name="accident_code",
        column_class_name="ForeignKey",
        column_class=ForeignKey,
        params={
            "references": AccidentCode,
            "on_delete": OnDelete.cascade,
            "on_update": OnUpdate.cascade,
            "target_column": None,
            "null": True,
    ...
    manager.add_column(
        ...
        params={
            ...
            "choices": Enum(
                "StatusEnum",
                {"okay": 1, "work_needed": 2, "destroyed_or_not_there": 0},
            ),
            "db_column_name": None,
            "secret": False,
        },
    ...
    manager.add_column(
        table_class_name="Ghostbike",
        tablename="ghostbike",
        column_name="status_checked_date",
        db_column_name="status_checked_date",
        column_class_name="Date",
        column_class=Date,
        params={
            "default": DateNow(),
